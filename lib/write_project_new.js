      ...
      [
        ...
        */
        function(callback){ // EXECUTE TERMINAL COMMANDS
          ...
          console.log('\nJOINED LINEAGE ARRAY: ' + transformedData.lineageArrays.lineageArray.join());
          //var makeDirectoryCommand = 'mkdir -p generated/' + transformedData.data.apiOptions.apiName + '/{models,shared,templates,views,routes/{' + transformedData.lineageArrays.lineageArray.join() + '}}';
          var makeModelsDirectoryCommand = 'mkdir -p generated/' + transformedData.data.apiOptions.apiName + '/models/';
          var makeSharedDirectoryCommand = 'mkdir -p generated/' + transformedData.data.apiOptions.apiName + '/shared/';
          var makeTemplatesDirectoryCommand = 'mkdir -p generated/' + transformedData.data.apiOptions.apiName + '/templates/';
          var makeViewsDirectoryCommand = 'mkdir -p generated/' + transformedData.data.apiOptions.apiName + '/views/';
          var makeRoutesDirectoryCommand = 'mkdir -p generated/' + transformedData.data.apiOptions.apiName + '/routes/';
          commands.push(makeModelsDirectoryCommand, makeSharedDirectoryCommand, makeTemplatesDirectoryCommand, makeViewsDirectoryCommand, makeRoutesDirectoryCommand);
          /*
          async.each(transformedData.lineageArrays.lineageArray, function(route, callback) {
          ...
          */
          for(i=0; i< transformedData.lineageArrays.lineageArray.length; i++){
            var route = transformedData.lineageArrays.lineageArray[i];
            var routeDirectoryCommand = 'mkdir -p generated/' + transformedData.data.apiOptions.apiName + '/routes/' + route;
            commands.push(routeDirectoryCommand);
          }
          var copyFilesCommand = 'cp -r staticSource/* generated/' + transformedData.data.apiOptions.apiName + '/';
          commands.push(copyFilesCommand);
          executeTerminalCommands(commands, callback);
        },
