module.exports = function FriendsRoutes(app) {
  ...
  //  RESOURCE VARIABLES
  var resourceName = 'friends';
  var parentResourceName = '';
  var resourcesLength = 1;
  var lineage = 'friends';
  var lineageArray = ['friends'];
  ...
  app.get('/friends/:friendsInstanceId', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    if (parentResourceName !== ''){
  ...
  app.put('/friends/:friendsInstanceId', function(req, res, next){      
    var parentPath = '';
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
        if(i == 0){
  ...
  app.del('/friends/:friendsInstanceId', function(req, res, next){ // ONLY USED IN CASES WHERE THE SUB-INSTANCE IS PART OF A SEPARATE PARENT INSTANCE
    var parentPath = '';
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
        if(i == 0){
