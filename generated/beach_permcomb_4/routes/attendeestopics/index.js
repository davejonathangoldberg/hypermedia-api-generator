module.exports = function AttendeesTopicsRoutes(app) {
  ...
  var parentResourceName = 'attendees';
  var resourcesLength = 2;
  var lineage = 'attendeestopics';
  var lineageArray = ['attendees','topics'];
  ...
  app.get('/attendees/:attendeesInstanceId/topics', function(req, res, next){
    var parentPath = '';
  ...
  app.post('/attendees/:attendeesInstanceId/topics', function(req, res, next){      
    var parentPath = '';
    var instancesArray = [];
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
  ...
  app.get('/attendees/:attendeesInstanceId/topics/:topicsInstanceId', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    if (parentResourceName !== ''){
  ...
  app.put('/attendees/:attendeesInstanceId/topics/:topicsInstanceId', function(req, res, next){      
    var parentPath = '';
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
        if(i == 0){
  ...
  app.del('/attendees/:attendeesInstanceId/topics/:topicsInstanceId', function(req, res, next){ // ONLY USED IN CASES WHERE THE SUB-INSTANCE IS PART OF A SEPARATE PARENT INSTANCE
    var parentPath = '';
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
        if(i == 0){
