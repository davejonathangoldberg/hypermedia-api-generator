module.exports = function Personal-informationRoutes(app) {
  ...
  //  RESOURCE VARIABLES
  var resourceName = 'personal-information';
  var parentResourceName = '';
  var resourcesLength = 1;
  var lineage = 'personal-information';
  var lineageArray = ['personal-information'];
  ...
  app.get('/personal-information', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
  ...
  app.put('/personal-information', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    var instancesArray = [];
  ...
  app.del('/personal-information', function(req, res, next){ // ONLY USED IN CASES WHERE THE SUB-INSTANCE IS PART OF A SEPARATE PARENT INSTANCE
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    req.params[resourceName + 'InstanceId'] = resourceName;
