module.exports = function SpeakersTopicsRoutes(app) {
  ...
  var lineage = 'speakerstopics';
  var lineageArray = ['speakers','topics'];
  ...
  app.get('/speakers/:speakersInstanceId/topics', function(req, res, next){
    var parentPath = '';
  ...
  app.post('/speakers/:speakersInstanceId/topics', function(req, res, next){      
    var parentPath = '';
    var instancesArray = [];
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
  ...
  app.get('/speakers/:speakersInstanceId/topics/:topicsInstanceId', function(req, res, next){      
    var parentPath = '';
    var query = {};
    var queryOptions = {};
    if (parentResourceName !== ''){
  ...
  app.put('/speakers/:speakersInstanceId/topics/:topicsInstanceId', function(req, res, next){      
    var parentPath = '';
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
        if(i == 0){
  ...
  app.del('/speakers/:speakersInstanceId/topics/:topicsInstanceId', function(req, res, next){ // ONLY USED IN CASES WHERE THE SUB-INSTANCE IS PART OF A SEPARATE PARENT INSTANCE
    var parentPath = '';
    if (parentResourceName !== ''){
      for(var i=0; i < resourcesLength-1; i++){
        if(i == 0){
