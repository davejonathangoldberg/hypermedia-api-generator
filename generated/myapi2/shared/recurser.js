...
meta['submarines'] = {'children' : ['widgets'], 'parents' : ['posts'], 'stubs' : []};
  ...
  async.waterfall(
    [
      ...
      function(results, callback){
        ...
        if (meta[results.resourceName].children.length > 0) {
          var childData = [];
          for (var i = 0; i < meta[results.resourceName].children.length; i++){
            childData[i] = {};
            var childResource = meta[results.resourceName].children[i];
