module.exports = function PostsTagsRoutes(app) {
  ...
  app.get('/posts/:postsInstanceId/tags', function(req, res, next){
    var parentPath = '';
  ...
  app.get('/posts/:postsInstanceId/tags/:tagsInstanceId', function(req, res, next){      
    var parentPath = '';
    for(var i=0; i < resourcesLength-1; i++){
      if(i == 0){
        parentPath = req.params['resource' + i + 'InstanceId'];
  ...
  app.put('/posts/:postsInstanceId/tags/:tagsInstanceId', function(req, res, next){      
    var parentPath = '';
    for(var i=0; i < resourcesLength-1; i++){
      if(i == 0){
        parentPath = req.params['resource' + i + 'InstanceId'];
  ...
  app.del('/posts/:postsInstanceId/tags/:tagsInstanceId', function(req, res, next){ // ONLY USED IN CASES WHERE THE SUB-INSTANCE IS PART OF A SEPARATE PARENT INSTANCE
    var parentPath = '';
    for(var i=0; i < resourcesLength-1; i++){
      if(i == 0){
        parentPath = req.params['resource' + i + 'InstanceId'];
